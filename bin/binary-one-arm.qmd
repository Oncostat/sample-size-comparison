...
The same classification used in other sections was applied to contextualize results:
...
- In **low‑relevancy** designs, deviations become the largest, with ratios extending well below 0.9 and occasionally above 1.5.
