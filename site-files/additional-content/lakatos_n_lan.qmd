...
```{r}
#| out-width: 100%
x$plot_lakatos_n_lan + theme_flatly() + theme(axis.text.x = element_text(angle = 45, hjust = 1))
```
:::
...
```{r}
#| out-width: 100%
x$plot_lakatos_n_lan + theme_darkly() + theme(axis.text.x = element_text(angle = 45, hjust = 1))
```
:::
