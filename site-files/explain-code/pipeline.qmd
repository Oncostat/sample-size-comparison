...
The entire internship workflow can be launched from a single file, [`main.R`](https://github.com/Oncostat/sample-size-comparison/blob/main/R/main.R), which executes the full pipeline.  
