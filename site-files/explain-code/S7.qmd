...
- [ssc_design](https://github.com/Oncostat/sample-size-comparison/blob/main/R/S7/ssc_design.R): represents a study design (endpoint, type, parameters, computation rules).
- [ssc_results](https://github.com/Oncostat/sample-size-comparison/blob/main/R/S7/ssc_results.R): stores the associated sample size results produced by different software tools.
